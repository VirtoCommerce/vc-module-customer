...
namespace VirtoCommerce.CustomerModule.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MembersSearchCriteria :  IEquatable<MembersSearchCriteria>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MembersSearchCriteria {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MembersSearchCriteria);
        }

        /// <summary>
        /// Returns true if MembersSearchCriteria instances are equal
        /// </summary>
        /// <param name="other">Instance of MembersSearchCriteria to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MembersSearchCriteria other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
