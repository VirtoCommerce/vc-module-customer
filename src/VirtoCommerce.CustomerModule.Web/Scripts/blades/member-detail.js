angular.module('virtoCommerce.customerModule').controller('virtoCommerce.customerModule.memberDetailController', [
    '$scope', '$timeout',
    'platformWebApp.bladeNavigationService', 'platformWebApp.dynamicProperties.api', 'platformWebApp.settings', 'platformWebApp.userProfileIconService',
    'virtoCommerce.customerModule.members', 'virtoCommerce.customerModule.organizations',
    function ($scope, $timeout, bladeNavigationService, dynamicPropertiesApi, settings, userProfileIconService, members, organizationsResource) {
